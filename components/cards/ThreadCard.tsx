...
// Define the interface for the props of ThreadCard component
interface Props {
    id: string,
    ...
    isComment?: boolean;    // Flag to determine if current card is a comment or a main thread
}

// ThreadCard component displays threads or comments in a styled card format
const ThreadCard = ({
    id,
    currentUserId,
    parentId,
